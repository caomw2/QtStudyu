...
QT_MOC_LITERAL(1, 6, 10), // "isSelected"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 4) // "rect"

    },
    "MyWin\0isSelected\0\0rect"
};
...
void MyWin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->isSelected((*reinterpret_cast< QRect(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (MyWin::*_t)(QRect );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyWin::isSelected)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject MyWin::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_MyWin.data,
...
// SIGNAL 0
void MyWin::isSelected(QRect _t1)
{
