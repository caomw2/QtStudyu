...
QT_MOC_LITERAL(1, 11, 10), // "userDelete"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 16), // "QTreeWidgetItem*"
QT_MOC_LITERAL(4, 40, 4), // "item"
QT_MOC_LITERAL(5, 45, 11) // "OnBtnDelete"

    },
    "CellWidget\0userDelete\0\0QTreeWidgetItem*\0"
    "item\0OnBtnDelete"
};
...
void CellWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { int _r = _t->userDelete((*reinterpret_cast< QTreeWidgetItem*(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = _r; }  break;
        case 1: _t->OnBtnDelete(); break;
        default: ;
        }
        ...
        {
            typedef int (CellWidget::*_t)(QTreeWidgetItem * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CellWidget::userDelete)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
int CellWidget::userDelete(QTreeWidgetItem * _t1)
{
    int _t0 = int();
