...
public:
    ...
    void setupUi(QMainWindow *Test5_2AClass)
    {
        ...
        editUer = new QLineEdit(centralWidget);
        editUer->setObjectName(QStringLiteral("editUer"));

        horizontalLayout->addWidget(editUer);
        ...
        editPasswd = new QLineEdit(centralWidget);
