...
public:
    ...
    void setupUi(QMainWindow *Test8_2AClass)
    {
        ...
        mEditTime = new QLabel(centralWidget);
        mEditTime->setObjectName(QStringLiteral("mEditTime"));
        mEditTime->setGeometry(QRect(100, 80, 201, 31));
    ...
    void retranslateUi(QMainWindow *Test8_2AClass)
    {
        ...
        mEditTime->setText(QApplication::translate("Test8_2AClass", "TextLabel", Q_NULLPTR));
    } // retranslateUi
